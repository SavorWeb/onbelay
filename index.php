...
<section id="welcome" class="editable row typeset">
	
	<div class="colspan12-12 colspan6-6 colspan2-2">
		<h1>Welcome to OnBelay</h1>
	</div>
	<div class="colspan12-6 colspan6-2 colspan2-2 as-grid">
		<p>OnBelay Security Solutions is a full service private investigative and security consulting firm that specializes in mitigating and solving security concerns. Our headquarters is located in Coeur d’Alene, Idaho with regional offices in Boise, Idaho and Houston, Texas. We have a strong affiliate presence nationally and internationally with the capability to provide investigations and consulting services world-wide. OnBelay personnel have conducted investigations and consulted on security matters</p>
	</div>
	<div class="colspan12-6 colspan6-2 colspan2-2 as-grid with-gutter">
...
<section class="row typeset">
	<div id="who-we-are" class="editable colspan12-9 colspan6-4 colspan2-2 as-grid">
	<h1>Who We Are</h1>
...
<br>
	...
	<div class="colspan12-3 colspan6-2 colspan2-2 as-grid with-gutter">
		<h2 id="location-title" class="editable">Our Locations</h2>
		<div id="addresses" class="editable">
		<div class="address repeatable">
